...
export const AuditAction = {
  ...
  DUES_BENEFIT_CREATED: 'DUES_BENEFIT_CREATED',
  DUES_BENEFIT_REVOKED: 'DUES_BENEFIT_REVOKED',
  DUES_BENEFIT_APPLIED: 'DUES_BENEFIT_APPLIED',
  ...
  DUES_AGREEMENT_CREATED: 'DUES_AGREEMENT_CREATED',
  DUES_AGREEMENT_REVISED: 'DUES_AGREEMENT_REVISED',
  DUES_COMMUNITY_WORK_CREATED: 'DUES_COMMUNITY_WORK_CREATED',
  DUES_CASH_SHIFT_OPENED: 'DUES_CASH_SHIFT_OPENED',
  DUES_CASH_TENDER_RECORDED: 'DUES_CASH_TENDER_RECORDED',
  DUES_CASH_SUPPORTING_RECORDED: 'DUES_CASH_SUPPORTING_RECORDED',
  DUES_CASH_SHIFT_CLOSED: 'DUES_CASH_SHIFT_CLOSED',
  DUES_CASH_EXPENSE_INCLUDED: 'DUES_CASH_EXPENSE_INCLUDED',
  DUES_CASH_EXPENSE_COMPENSATED: 'DUES_CASH_EXPENSE_COMPENSATED',
  DUES_CTACTE_PROJECTED: 'DUES_CTACTE_PROJECTED',
  CONDONATION_REQUEST_CREATED: 'CONDONATION_REQUEST_CREATED',
  CONDONATION_DECISION_RECORDED: 'CONDONATION_DECISION_RECORDED',
  CONDONATION_EXECUTED: 'CONDONATION_EXECUTED',
  COMMUNITY_WORK_REQUEST_CREATED: 'COMMUNITY_WORK_REQUEST_CREATED',
  COMMUNITY_WORK_DECISION_RECORDED: 'COMMUNITY_WORK_DECISION_RECORDED',
  COMMUNITY_WORK_EXECUTED: 'COMMUNITY_WORK_EXECUTED',
} as const
