...
describe('cash desk PostgreSQL policy', () => {
  ...
  it('preflights duplicate OPEN owners before adding the owner index and retains the desk index', async () => {
    ...
    ).rejects.toThrow('A desk or operator already has an open shift')
