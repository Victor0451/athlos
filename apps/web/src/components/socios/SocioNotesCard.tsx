...
export function SocioNotesCard({ socioId }: SocioNotesCardProps) {
  ...
  return (
    ...
    >
      ...
      {/* Collapsible region — wraps the new-note form and the notes list.
          Rendered only when displayExpanded is true (PR 8b.6). */}
      {displayExpanded ? (
        <div
          id="socio-notes-panel"
          data-testid="notes-panel"
          role="region"
          aria-labelledby="socio-notes-heading"
          className="mt-6 space-y-6"
        >
          {/* New note form */}
          <form onSubmit={handleSubmitDraft} data-testid="socio-note-new-form">
