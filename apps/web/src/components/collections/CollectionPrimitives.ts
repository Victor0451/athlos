...
export const collectionFieldClass =
  'min-h-11 w-full border border-ink-300 bg-surface px-3 font-body text-sm text-ink-900'

export const collectionButtonClass = {
  primary:
    'min-h-11 border border-accent bg-accent px-4 font-display text-sm font-semibold text-accent-foreground hover:bg-accent-hover',
  secondary:
    'min-h-11 border border-ink-300 bg-surface px-4 font-display text-sm font-semibold text-ink-700 hover:bg-surface-sunken',
  danger:
    'min-h-11 border border-danger bg-danger px-4 font-display text-sm font-semibold text-white hover:bg-accent-hover',
} as const
